...
<p>&nbsp;</p>
<strong>Follow up:</strong> If you have figured out the <code>O(n)</code> solution, try coding another solution of which the time complexity is <code>O(n log(n))</code>.<div><div>Related Topics</div><div><li>Array</li><li>Binary Search</li><li>Sliding Window</li><li>Prefix Sum</li></div></div><br><div><li>👍 6263</li><li>👎 182</li></div>